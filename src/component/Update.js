...
function Update() {
  ...
  useEffect(()=>{
    axios.get(`https://port-0-backend-mbiobnhr0088e901.sel4.cloudtype.app/goods/${g_code}`)
    //성공이면 출력
    .then(res=>{
  ...
  //사용자가 입력 양식에 데이터를 입력했을 경우 상태 변수에 저장하기
  ...
  const handleSubmit=(e)=>{  
    ...
    axios.put(`https://port-0-backend-mbiobnhr0088e901.sel4.cloudtype.app/goods/update/${g_code}`,{
