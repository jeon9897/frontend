...
function FruitsUpdate(props) {
  ...
  useEffect(()=>{
    //axios.get(`https://localhost:9070/fruits/${num}`)
    axios.get(`https://port-0-backend-express-server-mkvweaew5df78f72.sel3.cloudtype.app/fruits/${num}`)
    //성공이면
    .then(res=>{
  ...
  const handleSubmit=(e)=>{
    ...
    axios.put(`https://port-0-backend-express-server-mkvweaew5df78f72.sel3.cloudtype.app/fruits/fruitsupdate/${num}`,{
